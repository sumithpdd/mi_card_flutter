...
import 'package:mi_card/components//diagonally_cut_colored_image.dart';
import 'package:mi_card/mycontact.dart';
import 'package:meta/meta.dart';

class MyContactDetailHeader extends StatelessWidget {
  ...
  Widget _buildAvatar() {
    return new Hero(
      ...
      child: new CircleAvatar(
        backgroundImage: new AssetImage(myContact.avatar),
        radius: 50.0,
      ),
    );
  }
